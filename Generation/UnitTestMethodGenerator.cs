...
namespace UnitySpec.Generator.Generation
{
    public class UnitTestMethodGenerator
    {
            ...
            ExpressionSyntax additionalTagsExpression = null, ParameterSubstitution paramToIdentifier = null)
        {
            ...
            testMethod = testMethod.WithBody(testMethod.Body.AddStatements(GenerateScenarioCleanupMethodCall()));
            return testMethod;
        ...
        internal ExpressionStatementSyntax GenerateScenarioCleanupMethodCall()
        {
